...
#        error "Tomak split USB-C wiring must not use full-duplex serial."
#    endif
#    if SERIAL_USART_TX_PIN != GP1
#        error "Tomak split serial must use GP1/RX_C/D+ as the single-wire half-duplex line."
#    endif

static void tomak_disable_unused_split_tx_pin(void) {
