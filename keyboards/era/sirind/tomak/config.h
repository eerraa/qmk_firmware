...
#define TOMAK_EEPROM_SYNC_ENABLE
...
#    error "Tomak split USB-C wiring must not use full-duplex serial; GP0/TX would be driven against the other half."
#endif

#if SERIAL_USART_TX_PIN != GP1
#    error "Tomak split serial must use GP1/RX_C/D+ as the single-wire half-duplex line."
#endif

/* Sync configuration */
#define TOMAK_CONFIG_SYNC
#define SPLIT_TRANSACTION_IDS_KB TOMAK_SPLIT_FAST_SYNC, TOMAK_SPLIT_SLOW_SYNC, RPC_ID_KB_CONFIG_SYNC, RPC_ID_TOMAK_EEPROM_SYNC
