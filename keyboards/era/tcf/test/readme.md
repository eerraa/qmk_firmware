# The Cloud Factory, LED Controller

* Keyboard Maintainer: [ERA](https://github.com/eerraa)
* Hardware supported: The Cloud Factory Artisan Stand
* Hardware availability: The Cloud Factory

Make example for this keyboard (after setting up your build environment):

    make era/tcf/test:default

Flashing example for this keyboard:

    make era/tcf/test:default:flash
